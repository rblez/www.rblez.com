...
<div className="not-prose flex flex-wrap gap-6 justify-center items-center my-8">
  <img src="/qwen-code.png" alt="Qwen Code" className="h-8 w-auto" />
  <img src="/opencode.png" alt="OpenCode" className="h-8 w-auto" />
  <img src="/claude-code.png" alt="Claude Code" className="h-8 w-auto" />
  <img src="/codex.png" alt="Codex" className="h-8 w-auto" />
  <img src="/trae.png" alt="Trae" className="h-8 w-auto" />
  <img src="/cursor.png" alt="Cursor" className="h-8 w-auto" />
  <img src="/windsurf.png" alt="Windsurf" className="h-8 w-auto" />
</div>
